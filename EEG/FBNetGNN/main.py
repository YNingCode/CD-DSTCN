...
from EEG.FBNetGNN.model import *
import argparse
import warnings
...
# main settings
parser = argparse.ArgumentParser(description='FBNetGNN')
...
for subj_idx in range(1, 26):
    ...
    for train_and_val_indices, test_indices in KF.split(dataset):
        ...
        for epoch in range(args.epochs):
            ...
            print(
                'subj_idx:{},fold:{},epoch: {}, Train Loss: {:.6f}, Train Acc: {:.6f}, Eval Loss: {:.6f}, Eval Acc: {:.6f},precision : {'
